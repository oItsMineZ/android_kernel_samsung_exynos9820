...
extern void dhd_irq_set_affinity_cpucore(dhd_pub_t *dhdp, unsigned long cpucore);
...
int dhd_log_dump_ring_to_file(dhd_pub_t *dhdp, void *ring_ptr, void *file,
		...
		uint32 sec_type);
int dhd_ecntrs_log_dump_ring(dhd_pub_t *dhdp, void *ring_ptr, const void *user_buf,
		log_dump_section_hdr_t *sec_hdr, char *text_hdr, int buflen);
