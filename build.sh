...
toolchain ()
{
    ...
    git submodule add -f https://gitlab.com/crdroidandroid/android_prebuilts_clang_host_linux-x86_clang-r475365b.git toolchain/clang-r475365b

    CLANG=$DIR/toolchain/clang-r475365b
